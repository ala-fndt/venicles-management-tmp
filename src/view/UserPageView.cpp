    ...
    : wxPanel(window), validator(validator), _model(model)
{
    ...
    backButton =
        new wxButton(scrolledWindow,
                     wxID_ANY,
                     "Powrot",
                     wxDefaultPosition,
                     wxSize(-1, 38));

    backButton->SetBackgroundColour(
        wxColour(55, 65, 81));

    backButton->SetForegroundColour(
    ...
    wxStaticText *panelText =
        new wxStaticText(mainPanel, wxID_ANY,
                         "Witaj w panelu uzytkownika",
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxALIGN_CENTER);

    panelText->SetForegroundColour(
        wxColour(156, 163, 175));
    ...
    panelSizer->Add(panelText, 0,
                    wxALIGN_CENTER | wxBOTTOM,
                    25);

    mainPanel->SetSizer(panelSizer);

    contentSizer->Add(mainPanel, 0,
                      wxEXPAND | wxLEFT |
                          wxRIGHT | wxBOTTOM,
                      40);
    ...
    contentSizer->Add(historyPanel, 0,
                      wxEXPAND | wxLEFT |
                          wxRIGHT | wxBOTTOM,
                      40);

    adminPanel =
        new wxPanel(scrolledWindow, wxID_ANY);

    adminPanel->SetBackgroundColour(
        wxColour(31, 41, 55));

    wxBoxSizer *adminSizer =
        new wxBoxSizer(wxVERTICAL);

    wxStaticText *adminTitle =
        new wxStaticText(adminPanel, wxID_ANY,
                         "Panel Administratora",
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxALIGN_CENTER);

    adminTitle->SetForegroundColour(
        wxColour(255, 255, 255));

    adminTitle->SetFont(
        wxFont(16, wxFONTFAMILY_DEFAULT,
               wxFONTSTYLE_NORMAL,
               wxFONTWEIGHT_BOLD));

    adminSizer->Add(adminTitle, 0,
                    wxALIGN_CENTER |
                        wxTOP | wxBOTTOM,
                    6);

    wxStaticText *adminSubTitle =
        new wxStaticText(adminPanel, wxID_ANY,
                         "Dodaj nowe auto do systemu",
                         wxDefaultPosition,
                         wxDefaultSize,
                         wxALIGN_CENTER);

    adminSubTitle->SetForegroundColour(
        wxColour(107, 114, 128));

    adminSubTitle->SetFont(
        wxFont(9, wxFONTFAMILY_DEFAULT,
               wxFONTSTYLE_NORMAL,
               wxFONTWEIGHT_NORMAL));

    adminSizer->Add(adminSubTitle, 0,
                    wxALIGN_CENTER |
                        wxBOTTOM,
                    24);

    wxFlexGridSizer *formSizer =
        new wxFlexGridSizer(2, 12, 12);

    formSizer->AddGrowableCol(1, 1);

    wxStaticText *vinLabel =
        new wxStaticText(adminPanel,
                         wxID_ANY,
                         "VIN:");

    vinLabel->SetForegroundColour(
        wxColour(156, 163, 175));
    ...
    vinInput =
        new wxTextCtrl(adminPanel,
                       wxID_ANY);

    vinInput->SetBackgroundColour(
        wxColour(17, 24, 39));

    vinInput->SetForegroundColour(
    ...
    brandLabel->SetForegroundColour(
        wxColour(156, 163, 175));
    ...
    brandInput->SetBackgroundColour(
        wxColour(17, 24, 39));

    brandInput->SetForegroundColour(
        wxColour(243, 244, 246));
    ...
    modelLabel->SetForegroundColour(
        wxColour(156, 163, 175));
    ...
    modelInput->SetBackgroundColour(
        wxColour(17, 24, 39));

    modelInput->SetForegroundColour(
        wxColour(243, 244, 246));
    ...
    yearInput->SetBackgroundColour(
        wxColour(17, 24, 39));

    yearInput->SetForegroundColour(
        wxColour(243, 244, 246));
    ...
    colorLabel->SetForegroundColour(
        wxColour(156, 163, 175));
    ...
    colorInput->SetBackgroundColour(
        wxColour(17, 24, 39));
    ...
    formSizer->Add(vinInput, 1,
                   wxEXPAND);

    formSizer->Add(brandLabel, 0,
                   wxALIGN_CENTER_VERTICAL |
                       wxRIGHT,
                   10);

    formSizer->Add(brandInput, 1,
                   wxEXPAND);

    formSizer->Add(modelLabel, 0,
                   wxALIGN_CENTER_VERTICAL |
                       wxRIGHT,
                   10);

    formSizer->Add(modelInput, 1,
                   wxEXPAND);

    formSizer->Add(yearLabel, 0,
                   wxALIGN_CENTER_VERTICAL |
                       wxRIGHT,
                   10);

    formSizer->Add(yearInput, 1,
                   wxEXPAND);

    formSizer->Add(colorLabel, 0,
                   wxALIGN_CENTER_VERTICAL |
                       wxRIGHT,
                   10);
    ...
    info->SetFont(wxFont(10, wxFONTFAMILY_DEFAULT,
    ...
    addVehicleButton =
        new wxButton(adminPanel,
                     wxID_ANY,
                     "Dodaj auto",
                     wxDefaultPosition,
                     wxSize(-1, 38));

    addVehicleButton->SetBackgroundColour(
        wxColour(99, 102, 241));

    addVehicleButton->SetForegroundColour(
        wxColour(255, 255, 255));

    addVehicleButton->SetFont(
        wxFont(10, wxFONTFAMILY_DEFAULT,
               wxFONTSTYLE_NORMAL,
               wxFONTWEIGHT_BOLD));

    btnSizer->Add(addVehicleButton, 0,
                  wxALIGN_CENTER_VERTICAL |
                      wxRIGHT,
                  10);

    adminSizer->Add(btnSizer, 0,
                    wxALIGN_CENTER |
                        wxBOTTOM,
                    25);
    ...
    mainSizer->Add(scrolledWindow, 1,
                   wxEXPAND);
